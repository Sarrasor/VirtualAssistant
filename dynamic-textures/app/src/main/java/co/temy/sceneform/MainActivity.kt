...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        materialFuture = CustomMaterial.build(this) {
            baseColorSource = Uri.parse("textures/DefaultMaterial_Base_Color_1.png")
            metallicSource = Uri.parse("textures/DefaultMaterial_Base_Color_2.png")
            roughnessSource = Uri.parse("textures/DefaultMaterial_Base_Color_3.png")
            normalSource = Uri.parse("textures/DefaultMaterial_Base_Color_4.png")
        }

        renderableFuture = ModelRenderable.builder()
            .setSource(this, Uri.parse("Doormat.sfb"))
            .build()
