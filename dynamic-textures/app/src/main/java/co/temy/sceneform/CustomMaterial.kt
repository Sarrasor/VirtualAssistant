...
class CustomMaterial private constructor(
    ...
    class Builder(val context: Context) {
        ...
        fun build(): CompletableFuture<CustomMaterial> {
            ...
            val defaultColorFuture = createTexture(R.raw.custom_material_default_normal, Texture.Usage.NORMAL)
            val defaultMetallicFuture = createTexture(R.raw.custom_material_default_normal, Texture.Usage.NORMAL)
            val defaultRoughnessFuture = createTexture(R.raw.custom_material_default_normal, Texture.Usage.NORMAL)
            val defaultNormalFuture = createTexture(R.raw.custom_material_default_normal, Texture.Usage.NORMAL)
            val baseColorFuture = createTexture(baseColorSource!!, Texture.Usage.NORMAL)
            val metallicFuture = createTexture(metallicSource!!, Texture.Usage.NORMAL)
            val roughnessFuture = createTexture(roughnessSource!!, Texture.Usage.NORMAL)
